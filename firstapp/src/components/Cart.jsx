...
export default function Cart() {
    ...
    async function fetchCart() {
        ...
        axios.get("https://project-qi10.onrender.com/api/cart", { params: { userId } })
            .then(res => {
                if (res.status === 200) {
                    setCart(res.data)
                    setLoading(false)
    ...
    async function deleteItem(productId) {
        axios.delete(`https://project-qi10.onrender.com/api/cart/remove/${productId}`, {
            params: { userId }
        })
            .then(res => {
                if (res.status === 200) {
    ...
    async function checkout() {
        axios.post("https://project-qi10.onrender.com/api/cart/checkout", {}, { params: { userId } })
            .then(res => {
                if (res.status === 200) {
